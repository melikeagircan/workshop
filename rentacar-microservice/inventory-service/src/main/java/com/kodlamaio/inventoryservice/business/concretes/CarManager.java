...
public class CarManager implements CarService {
    ...
    public CreateCarResponse add(CreateCarRequest request) {
        ...
        sendKafkaCarCreatedEvent(createdCar);  //car created event
    ...
    public UpdateCarResponse update(UUID id, UpdateCarRequest request) {
        ...
        car.setId(id);
        var createdCar=repository.save(car);
        var response=mapper.forResponse().map(createdCar,UpdateCarResponse.class);
    ...
    public void delete(UUID id) {
        ...
        sendKafkaCarDeletedEvent(id);//car deleted event
    }
    ...
    @Override
    public void changeStateByCarId(State state,UUID carId) {
